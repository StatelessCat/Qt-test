...
**
** Created: Tue Jul 2 19:25:07 2013
...
const QMetaObject SortDialog::staticMetaObject = {
    { &Ui::SortDialog::staticMetaObject, qt_meta_stringdata_SortDialog,
...
void *SortDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QDialog"))
        return static_cast< QDialog*>(const_cast< SortDialog*>(this));
    typedef Ui::SortDialog QMocSuperClass;
